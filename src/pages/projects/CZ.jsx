...
const CZ = () => {
  return (
    <ProjectDetails
      ...
      stats={[
        { num: "2+ yrs", label: "live and successfully running without updates" },
        { num: "100", label: "serial-numbered units in the first launched collection" },
        { num: "4", label: "core product team: CTO, PM, QA, Designer" },
        { num: "Email + OTP", label: "authentication model, kept deliberately lightweight" },
      ]}
      context={[
      ...
      problem={{
        heading: "Complex, high-value transactions that still had to feel premium and trustworthy.",
        paragraphs: [
      ...
      decisions={[
        {
          number: "01 — Ownership",
          title: "Represented ownership as a direct visual match to the specific serialized firearm, not a generic badge.",
          description:
        ...
        {
          number: "02 — Bidding",
          title: "Built outbid notifications into the bidding flow to keep trust intact under live competition.",
          description:
        ...
        },
        {
          ...
          title: "Kept authentication deliberately lightweight — email plus one-time passcode.",
          description:
        ...
        {
          number: "04 — Payments",
          title: "Redesigned the payment flow around manual bank transfer after card payments fell through.",
          description:
      ...
      finalDesign={{
        ...
        images: [
          {
            layers: [
              { src: czFinal1Layer1, style: { height: "107.35%", width: "100%", left: 0, top: "-0.72%" } },
              { src: czFinal1Layer2, style: { height: "114.54%", width: "114.15%", left: "-7.96%", top: "-1.1%" } },
            ],
          },
          { src: czFinal2 },
        ],
