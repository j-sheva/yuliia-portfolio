...
import rewardSystem1 from "../../assets/images/qu/qu-reward-system-1.webp";
import rewardSystem2 from "../../assets/images/qu/qu-reward-system-2.webp";
import activityFeed1 from "../../assets/images/qu/qu-activity-feed-1.webp";
import activityFeed2 from "../../assets/images/qu/qu-activity-feed-2.webp";
import login1 from "../../assets/images/qu/qu-login-1.webp";
import login2 from "../../assets/images/qu/qu-login-2.webp";
import networkMap1 from "../../assets/images/qu/qu-network-map-1.webp";
import networkMap2 from "../../assets/images/qu/qu-network-map-2.webp";
import finalDesign1 from "../../assets/images/qu/qu-final-design-1.webp";
import finalDesign2 from "../../assets/images/qu/qu-final-design-2.webp";
import finalDesign3 from "../../assets/images/qu/qu-final-design-3.webp";
import finalDesign4 from "../../assets/images/qu/qu-final-design-4.webp";
import finalDesign5 from "../../assets/images/qu/qu-final-design-5.webp";
import finalDesign6 from "../../assets/images/qu/qu-final-design-6.webp";
import iaImage from "../../assets/images/qu/qu-information-architecture.webp";
  ...
  return (
    <ProjectDetails
      ...
      stats={[
        {
          num: "~12 mo",
          label: "continuous, screen-by-screen collaboration with the founder",
        },
        {
          num: "5",
          label: "core actions structured into one navigable IA hub",
        },
        {
          num: "4",
          label: "key architecture decisions made under shifting constraints",
        },
      ...
      discovery={{
        heading:
          "Discovery meant extracting decisions from the CTO's evolving thinking, not analyzing an existing product.",
        paragraphs: [
      ...
      decisions={[
        {
          ...
          title:
            'Designed "points" as an abstraction that could survive a business model that hadn\'t been decided yet.',
          description:
          ...
          images: [{ src: rewardSystem1 }, { src: rewardSystem2 }],
        },
        {
          number: "02 — Network map",
          title:
            "Turned a fixed geospatial data structure into an explorable, gamified world map.",
          description:
          ...
          images: [{ src: networkMap1 }, { src: networkMap2 }],
        },
        {
          number: "03 — Activity feed",
          title:
            "Rebuilt the Activity feed's structure after a real cross-functional catch.",
          description:
          ...
          images: [{ src: activityFeed1 }, { src: activityFeed2 }],
        },
        {
          number: "04 — Authentication",
          title:
            "Redesigned login twice as the auth architecture changed under me.",
          description:
          ...
          images: [{ src: login1 }, { src: login2 }],
        },
      ]}
      process={{
        label: "Information Architecture",
        heading:
          "Structured a growing, half-defined feature list into one coherent map.",
        paragraphs: [
