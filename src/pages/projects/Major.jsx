...
import visualHierarchy from "../../assets/images/ml/visual-hierarchy.webp";
import myLinks from "../../assets/images/ml/my-links.webp";
import contractHistory1 from "../../assets/images/ml/contract-history-1.webp";
import contractHistory2 from "../../assets/images/ml/contract-history-2.webp";
import designToBuild from "../../assets/images/ml/design-to-build.webp";
import finalDesign1 from "../../assets/images/ml/final-design-1.webp";
import finalDesign2 from "../../assets/images/ml/final-design-2.webp";
import finalDesign3 from "../../assets/images/ml/final-design-3.webp";
import finalDesign4 from "../../assets/images/ml/final-design-4.webp";
import finalDesign5 from "../../assets/images/ml/final-design-5.webp";
import finalDesign6 from "../../assets/images/ml/final-design-6.webp";
  ...
  return (
    <ProjectDetails
      ...
      stats={[
        ...
        {
          num: "33",
          label: "screens mapped in the source UX-flow specification",
        },
        {
          num: "1",
          label: 'shared workspace model (the "B.A.P.") powering the whole IA',
        },
        {
          num: "HTML/CSS",
          label: "select flows implemented directly, not just designed",
        },
      ]}
      context={[
      ...
      problem={{
        heading:
          "A shared workspace with real legal and financial stakes, that still had to feel effortless.",
        paragraphs: [
      ...
      discovery={{
        heading:
          "Continuous fidelity-checking against an existing functional spec, not user research.",
        paragraphs: [
      ...
      decisions={[
        {
          ...
          title:
            "Established a one-accent-color rule to protect visual hierarchy as the product grew.",
          description:
          ...
          images: [{ src: visualHierarchy }],
        },
        {
          number: "02 — My Links",
          title:
            "Built a self-detecting links system instead of a fixed platform checklist.",
          description:
        ...
        },
        {
          ...
          title:
            "Gave contract amendments their own history, instead of letting edits overwrite the record.",
          description:
          ...
          images: [{ src: contractHistory1 }, { src: contractHistory2 }],
        },
        {
          number: "04 — Design-to-build",
          title:
            "Implemented select flows directly in HTML/CSS to close the gap between design and shipped product.",
          description:
