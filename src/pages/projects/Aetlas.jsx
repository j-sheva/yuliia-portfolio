...
const Aetlas = () => {
  return (
    <ProjectDetails
      ...
      stats={[
        { num: "2", label: "full personas, each iterated through a 1.0 → 1.1 pass" },
      ...
      problem={{
        heading: "Two audiences, one shared smart-contract system, and no room to hide the mechanics.",
        paragraphs: [
      ...
      discovery={{
        heading: "Reverse-engineering trust requirements from a technical spec, not conducting user research.",
        paragraphs: [
      ...
      decisions={[
        {
          ...
          title: "Treated a mid-project structural requirement as a navigation problem, not a form add-on.",
          description:
        ...
        },
        {
          ...
          title: "Kept real structured-finance vocabulary instead of softening it into consumer-style copy.",
          description:
        ...
        },
        {
          ...
          title: "Gave contract execution a distinct, accountable role instead of a generic \"confirm\" action.",
          description:
        ...
        groups: [
          {
            ...
            steps: [
              "Register & sign in",
              "Create project (Aetlas approval)",
              "List CDR certificates + offtake terms",
              "Pledge revenue as bond collateral (DSCR)",
              "Place certificates into escrow",
            ],
          },
          {
            ...
            steps: [
              "KYC & whitelisting",
              "Browse listings",
              "Commit to purchase (binding)",
              "Deposit funds into escrow",
            ],
          },
          {
            label: "Shared settlement",
            steps: ["Certificate verification", "Simultaneous release of funds & certificates"],
          },
        ],
      }}
      validation={[
